    ...
    >
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none">
        ...
        >
          ...
          <div className="relative flex gap-[6px] sm:gap-[10px] md:gap-[16px] items-center px-2">
            {lettersJainam.map((char, i) => (
              <motion.div
                key={i}
                className="flex items-center justify-center bg-[#0A0A0A] shadow-[4px_4px_0px_rgba(0,0,0,0.22)] sm:shadow-[6px_6px_0px_rgba(0,0,0,0.22)]"
                style={{
                  width: "clamp(48px, 12vw, 136px)",
                  height: "clamp(48px, 12vw, 136px)",
          ...
          {/* Spacer */}
          <div className="h-[24px] sm:h-[36px] md:h-[48px]" />
          ...
          <div className="relative flex gap-[6px] sm:gap-[10px] md:gap-[16px] items-center px-2">
            {lettersKhara.map((char, i) => (
              <motion.div
                key={i}
                className="flex items-center justify-center bg-white shadow-[4px_4px_0px_rgba(0,0,0,0.22)] sm:shadow-[6px_6px_0px_rgba(0,0,0,0.22)]"
                style={{
                  width: "clamp(48px, 12vw, 136px)",
                  height: "clamp(48px, 12vw, 136px)",
                  border: "2px solid #0A0A0A",
