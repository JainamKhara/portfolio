...
import { Plus, Home, User, Briefcase, Code, Mail, Github, Linkedin, Phone, X, Medal } from "lucide-react";
...
const navItems = [
  ...
  { title: "Certificates", href: "/certificates", icon: <Medal className="mr-2 h-4 w-4" /> },
