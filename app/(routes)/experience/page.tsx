          ...
          <div className="space-y-16">
            {experiences.map((exp, i) => (
              ...
              >
                {/* Dot on the spine */}
                <div
                  className={`absolute left-4 md:left-1/2 top-4 w-3 h-3 border-2 border-primary bg-background -translate-x-[5px] md:-translate-x-1/2 z-10 ${
                ...
                <div
                  className={`hidden md:flex items-start md:w-[calc(50%-2rem)] ${
        ...
        <div className="relative max-w-4xl mx-auto">
          ...
          <div className="space-y-16">
            {education.map((edu, i) => (
              ...
              >
                {/* Dot on the spine */}
                <div className="absolute left-4 md:left-1/2 top-4 w-3 h-3 border-2 border-primary bg-background -translate-x-[5px] md:-translate-x-1/2 z-10"></div>
